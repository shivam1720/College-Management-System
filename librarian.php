            ...
            <div class="box-content">
                <table border="1">
                    ...
                    <?php
                        ...
                        // Show Details
                        $display_data = "Select * from lib_messages where to_id='librarian'";
                        ...
                        if(mysqli_num_rows($result_data) > 0){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action='librarian.php' method='post'>
                                                ...
                                                <button class='approve' name='approve-btn' id='<?php echo $enrno; ?>-apr'
                                                    onclick='btnClick(this)'>Approve</button>
                                                <button class='reject' name='reject-btn' id='<?php echo $enrno; ?>-rjt'
                                                    onclick='btnClick(this)'>Reject</button>
                                            </form>
                            ...
                            <?php }
                                ...
                                if(isset($_POST["approve-btn"])){
                                    $val = $_POST["id"];
                                    $update_query = "update lib_messages set status='Approved' where studentid='$val'";
                                    $result = mysqli_query($conn,$update_query);
                                    echo("<meta http-equiv='refresh' content='1'>");

                                    $verify = "select * from it_fa_messages where studentid='$val'";
                                    ...
                                    if(mysqli_num_rows($verify_result) > 0 ){
                                        ...
                                        $message = "Clear : Fee Payment and Library Reccords";
                                        $student = $val;
                                        $query_acc = "Insert into it_fa_messages(to_id,from_id,studentid,subject,msg,status) values('$to_id','$from_id','$student','$subject','$message','Pending')";
                                ...
                                if(isset($_POST["reject-btn"])){
                                    $val = $_POST["id"];
                                    $update_query = "update lib_messages set status='Rejected' where studentid='$val'";
                                    $result = mysqli_query($conn,$update_query);
                                    echo("<meta http-equiv='refresh' content='1'>");
                                }
